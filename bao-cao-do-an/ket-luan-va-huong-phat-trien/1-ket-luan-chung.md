...
Tuy nhiên, hệ thống vẫn có những giới hạn về khả năng mở rộng và một số tính năng chưa được triển khai trong phạm vi đồ án — những điểm này được phân tích chi tiết trong mục Hạn Chế và Định Hướng Phát Triển.
