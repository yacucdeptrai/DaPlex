...
Bên cạnh những kết quả đạt được, DaPlex vẫn tồn tại một số hạn chế kỹ thuật và phạm vi chưa được giải quyết trong khuôn khổ đồ án. Việc nhìn nhận thẳng thắn những giới hạn này là cần thiết để đánh giá đúng phạm vi ứng dụng thực tế của hệ thống và làm cơ sở cho các hướng phát triển tiếp theo.
